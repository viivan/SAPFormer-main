...
def get_parser():
    parser = argparse.ArgumentParser(description='SAPFormer For Point Cloud Classification')
    parser.add_argument('--config', type=str, default='config/modelnet40/modelnet40_sapformer.yaml', help='config file')
    parser.add_argument('opts', help='see config/modelnet40/modelnet40_sapformer.yaml for all options', default=None, nargs=argparse.REMAINDER)
